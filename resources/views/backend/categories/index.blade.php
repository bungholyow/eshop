        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <a href="{{ route('category.create')}}" class=" float-right btn btn-xl btn-outline-secondary"><i class="fa fa-plus"></i> Add Category </a>
                    <ul class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="float-right">Total Category: <strong>{{ \App\Models\Category::count()}}</p></strong>
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->is_parent===1 ? 'Ya' : 'Tidak'}}</td>
