                    ...
                    <ul class="main-menu metismenu">
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-picture"></i><span>Banner</span> </a>
                            <ul>
                                ...
                                <li><a href="{{route('banner.create')}}"></i>Add Banner</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-layers"></i><span>Kategori</span> </a>
                            <ul>
                                <li><a href="{{route('category.index')}}">All Kategori</a></li>
                                <li><a href="{{route('category.create')}}"></i>Add Kategori</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-handbag"></i><span>Brand</span> </a>
                            <ul>
                        ...
                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-briefcase"></i><span>Produk</span> </a>
                            <ul>
                                <li><a href="{{route('product.index')}}">All Produk</a></li>
                                <li><a href="{{route('product.create')}}"></i>Add Produk</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-bag"></i><span>Order</span> </a>
                            <ul>
                                <li><a href="#">All Order</a></li>
                                <li><a href="add-#"></i>Add Order</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-basket"></i><span>Cart</span> </a>
                            <ul>
                                <li><a href="#">All Cart</a></li>
                                <li><a href="add-#"></i>Add Cart</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-organization"></i><span>Post Kategori</span> </a>
                            <ul>
                                <li><a href="#">All Post Kategori</a></li>
                                <li><a href="add-#"></i>Add Post Kategori</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-tag"></i><span>Post Tag</span> </a>
                            <ul>
                                <li><a href="#">All Post Tag</a></li>
                                <li><a href="add-#"></i>Add Post Tag</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-note"></i><span>Post</span> </a>
                            <ul>
                                <li><a href="#">All Post</a></li>
                                <li><a href="add-#"></i>Add Post</a></li>
                            </ul>
                        </li>



                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-puzzle"></i><span>Kupon</span> </a>
                            <ul>
                                <li><a href="#">All Kupon</a></li>
                                <li><a href="add-#"></i>Add Kupon</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-speech"></i><span>Komentar</span> </a>
                            <ul>
                                <li><a href="#">All Komentar</a></li>
                                <li><a href="add-#"></i>Add Komentar</a></li>
                            </ul>
                        </li>

                        <li><a href="javascript:void(0);" class="has-arrow"><i class="icon-user"></i><span>User</span> </a>
                            <ul>
                                <li><a href="#">All User</a></li>
                                <li><a href="add-#"></i>Add User</a></li>
                            </ul>
                        </li>
